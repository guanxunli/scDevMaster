...
source("code/PR_Normalization.R")
source("code/scTenifoldTime.R")
dta <- readRDS("data/GSE137524_HNSCC_cells/data/dta_rep2.rds")
sudotime <- readRDS("data/GSE137524_HNSCC_cells/data/sudotime2.rds")
...
res <- scTenifoldTime(dta_list = dta_list, method = "pcnet", time_vec = time_vec,
                      nComp = 5, q = 0, K = 5)
saveRDS(res, paste0("data/GSE137524_HNSCC_cells/results/networks/res_pcnet2_ngroup", 
                    n_group, ".rds"))
