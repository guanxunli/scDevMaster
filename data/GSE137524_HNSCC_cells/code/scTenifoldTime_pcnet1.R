...
dta <- readRDS("data/GSE137524_HNSCC_cells/data/dta_rep1.rds")
sudotime <- readRDS("data/GSE137524_HNSCC_cells/data/sudotime1.rds")
...
saveRDS(res, paste0(
  "data/GSE137524_HNSCC_cells/results/networks/res_pcnet1_ngroup",
  n_group, ".rds"
))